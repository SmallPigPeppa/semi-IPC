...
def main():
    ...
    for task_idx in range(0, args.num_tasks):
        ...
        supervised_data = keep_n_samples_per_class(train_dataset_task, n=args.num_sample)
        supervised_data_std = keep_n_samples_per_class(train_dataset_task_std, n=args.num_sample)
