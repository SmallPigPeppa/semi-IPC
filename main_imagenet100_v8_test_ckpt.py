...
from models.icpn_protoAug_semi_2view_blance_add_dualloss_v8_test import IncrementalCPN
...
def main():
    ...
    for task_idx in range(0, args.num_tasks):
        ...
        wandb_logger = WandbLogger(
            ...
            project=f"{args.project}-task{task_idx}",
            entity=args.entity,
            offline=False,
        )
        if args == 0:
        ...
        root_dir = f'test-imagenet100-task{task_idx}'
