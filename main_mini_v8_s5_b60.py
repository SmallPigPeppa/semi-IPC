...
def main():
    ...
    for task_idx in range(0, args.num_tasks):
        ...
        if task_idx == 0:
            supervised_data = keep_n_samples_per_class(train_dataset_task, n=100)
            supervised_data_std = keep_n_samples_per_class(train_dataset_task_std, n=100)
            ...
            test_loader = DataLoader(test_dataset_task, batch_size=64, shuffle=True, num_workers=4)
            supervised_loader = DataLoader(supervised_data, batch_size=256, shuffle=True, num_workers=4)
            supervised_loader_std = DataLoader(supervised_data_std, batch_size=256, shuffle=True, num_workers=4)
            ...
            train_loader = DataLoader(train_dataset_task, batch_size=64, shuffle=True, num_workers=4)
            dual_loader = DataLoader(dual_dataset_task, batch_size=64, shuffle=True, num_workers=4)
            test_loader = DataLoader(test_dataset_task, batch_size=64, shuffle=True, num_workers=4)
            supervised_loader = DataLoader(supervised_data, batch_size=64, shuffle=True, num_workers=4)
            supervised_loader_std = DataLoader(supervised_data_std, batch_size=64, shuffle=True, num_workers=4)
            model.batch_size = 64
