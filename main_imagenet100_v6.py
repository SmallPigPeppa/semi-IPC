...
from utils.dataset_utils_v2 import get_dataset as get_dataset_v2
from pytorch_lightning.callbacks import LearningRateMonitor
from utils.encoder_utils import get_pretrained_encoder
from utils.args_utils import parse_args_cpn
from models.icpn_protoAug_semi_2view_blance_add_dualloss_v6 import IncrementalCPN
...
def main():
    ...
    train_dataset_v2, _ = get_dataset_v2(dataset=args.dataset, data_path=args.data_path)
    ...
    for task_idx in range(0, args.num_tasks):
        ...
        train_dataset_task_v2 = split_dataset(
            train_dataset_v2,
            tasks=tasks,
            task_idx=[task_idx],
        )
        ...
        supervised_data_v2 = keep_n_samples_per_class(train_dataset_task_v2, n=10, return_means=False)
        supervised_loader = DataLoader(supervised_data, batch_size=64, shuffle=True,pin_memory=True, num_workers=4)
        supervised_loader_v2 = DataLoader(supervised_data_v2, batch_size=64, shuffle=True,pin_memory=True, num_workers=4)

        train_loaders = {
            "unsupervised_loader": train_loader,
            "supervised_loader": supervised_loader,
            "supervised_loader_v2": supervised_loader_v2,
