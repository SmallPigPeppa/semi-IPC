...
def main():
    ...
    for task_idx in range(0, args.num_tasks):
        ...
        test_loader = DataLoader(test_dataset_task, batch_size=args.batch_size, shuffle=True)
        train_loader = DataLoader(train_dataset_task, batch_size=args.batch_size, shuffle=True)
