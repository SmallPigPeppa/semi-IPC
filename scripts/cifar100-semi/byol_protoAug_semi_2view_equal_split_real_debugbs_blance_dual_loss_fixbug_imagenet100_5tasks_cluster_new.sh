...
CUDA_VISIBLE_DEVICES=0 python main_continual_protoAug_semi_2view_equal_split_real_remove_fixfeature_debugbs_blance_dualloss_fixbug_imagenet100_new.py \
  --num_tasks 5 \
...
#
#
#CUDA_VISIBLE_DEVICES=0 python main_imagenet100.py \
#  --num_tasks 5 \
