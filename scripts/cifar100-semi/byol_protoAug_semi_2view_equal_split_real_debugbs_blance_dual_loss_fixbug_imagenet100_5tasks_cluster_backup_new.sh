...
CUDA_VISIBLE_DEVICES=1 python main_continual_protoAug_semi_2view_equal_split_real_remove_fixfeature_debugbs_blance_dualloss_fixbug_imagenet100_backup_new.py \
  --num_tasks 5 \
