...
CUDA_VISIBLE_DEVICES=0 python main_imagenet100_v8_test.py \
  --num_tasks 5 \
  --pretrained_model /lustre/home/wzliu/test-project/ssl-pretrain/imagenet/byol-imagenet-3tx0at58-ep=999.ckpt \
  --pretrained_method byol \
  --dataset imagenet100 \
  --data_path /lustre/home/wzliu/torch_ds/imagenet100 \
  --pl_lambda 0.2 \
  --project debug-imagenet100 \
  --epochs 50 \
  --perfix v8-semi-dual- \
  --cpn_initial means
