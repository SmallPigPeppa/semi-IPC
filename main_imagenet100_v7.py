...
def main():
    ...
    for task_idx in range(0, args.num_tasks):
        ...
        supervised_loader = DataLoader(supervised_data, batch_size=bs, shuffle=True, pin_memory=True, num_workers=4)
        supervised_loader_std = DataLoader(supervised_data_std, batch_size=bs, shuffle=True, pin_memory=True, num_workers=4)
