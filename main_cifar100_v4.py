...
from utils.dataset_utils_v0_cifar import get_dataset, get_pretrained_dataset, split_dataset, get_dual_dataset, get_dataset_std
...
def main():
    ...
    for task_idx in range(0, args.num_tasks):
        ...
        supervised_loader_std = DataLoader(supervised_data_std, batch_size=64, shuffle=True)
        model.batch_size = 64
