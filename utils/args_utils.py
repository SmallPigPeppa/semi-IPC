...
def parse_args_cpn() -> argparse.Namespace:
    ...
    parser.add_argument("--pa_lambda", type=float, default=1.0)
    parser.add_argument("--dual_lambda", type=float, default=1.0)
    ...
    parser.add_argument("--dataset", type=str, choices=["cifar100", "imagenet100","imagenet-subset","imagenet-subset-new","cub200","mini"], default="cifar100")
