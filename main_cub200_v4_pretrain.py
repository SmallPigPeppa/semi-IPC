...
from models.icpn_protoAug_semi_2view_blance_add_dualloss_v3_cub_pretrain import IncrementalCPN
...
def main():
    ...
    for task_idx in range(0, args.num_tasks):
        ...
        # model.protoAug_end()
        if task_idx == 0:
            trainer.save_checkpoint("byol-cub100-resnet50.ckpt")
            print(f'Model saved to byol-cub100-resnet50.ckpt')
            break
